...
/**
 * Dev-only panel for manually verifying the SEP-10 auth round trip against
 * a live anchor. Not rendered in production — gate any usage of this
 * component behind `process.env.NODE_ENV !== 'production'` at the call site.
 */
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50 max-w-md rounded-xl border border-slate-200 bg-white p-4 shadow-lg text-xs">
      <div className="flex items-center justify-between mb-2">
        <span className="font-semibold text-slate-600">SEP-10 Dev Test</span>
        <button
          onClick={run}
          disabled={running}
