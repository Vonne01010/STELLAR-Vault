...
export function CreateIcon({ className = '' }) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 442 442" xmlns="http://www.w3.org/2000/svg">
      <path d="M372,0H70A70,70 0 0 1 0,70V372A70,70 0 0 1 70,442H372A70,70 0 0 1 442,372V70A70,70 0 0 1 372,0Z M372,422H70A50,50 0 0 0 20,372V70A50,50 0 0 0 70,20H372A50,50 0 0 0 422,70V372A50,50 0 0 0 372,422Z"></path>
...
export function CollaborativeIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
